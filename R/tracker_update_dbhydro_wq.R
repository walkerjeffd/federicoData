...
#' @param date_min start date for period to update, or NULL to use station start date
#' @param date_max end date for period to update, or NULL to use station end date
